...
int main(void) {
	...
	for (;;) {
		...
		memcpy(&transfer1[1], &Mario_pixel_map[current_line * 32],
				8 * sizeof(uint8_t));
		memcpy(&transfer2[1], &Mario_pixel_map[current_line * 32 + 8],
				8 * sizeof(uint8_t));
		memcpy(&transfer3[1], &Mario_pixel_map[current_line * 32 + 16],
				8 * sizeof(uint8_t));
		memcpy(&transfer4[1], &Mario_pixel_map[current_line * 32 + 24],
				8 * sizeof(uint8_t));
