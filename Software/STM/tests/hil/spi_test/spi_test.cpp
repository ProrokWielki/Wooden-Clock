...
RegisterTest(I2cTest, SpiGyroscope, [](Test * test) {
    ...
    GPIO SPI1_MISO = GPIO(clock, sys_config, GPIO_Types::Port::A, 11);
    GPIO SPI1_MOSI = GPIO(clock, sys_config, GPIO_Types::Port::A, 12);
    GPIO SPI1_SCK = GPIO(clock, sys_config, GPIO_Types::Port::A, 5);

    GPIO SPI1_CS1 = GPIO(clock, sys_config, GPIO_Types::Port::E, 0);
    GPIO SPI1_CS2 = GPIO(clock, sys_config, GPIO_Types::Port::B, 9);
    GPIO SPI1_CS3 = GPIO(clock, sys_config, GPIO_Types::Port::E, 1);
